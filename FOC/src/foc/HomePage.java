...
public class HomePage  extends JFrame{
	...
	protected JPanel createInnerPanelFaculty() {
	    ...
	    addDepart.setMnemonic(KeyEvent.VK_C); 
	    addDepart.setBounds(650,80,150,25);
	    addDepart.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				results2.removeAll();
				results2.append(myFaculty.start("add depart"));
			}
		});;
	    panel.add(addDepart);
	...
	private JButton addMembers, addCommittee, searchCommittee, removeCommittee, addChair, addDepart;	
